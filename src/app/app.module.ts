...
@NgModule({
  declarations: [AppComponent, AddRecipeComponent, LoginComponent, RecetarioComponent, SignUpComponent, CuentaComponent],
  imports: [BrowserModule, IonicModule.forRoot(), AppRoutingModule, FormsModule, ReactiveFormsModule, AngularFireModule.initializeApp({"projectId":"miapp-recetas-2132904","appId":"1:1047713110321:web:2876900a8608844b42b810","storageBucket":"miapp-recetas-2132904.appspot.com","apiKey":"AIzaSyA26zvSQbgLkZrh_dXadrfNPu5xs1QPvZ0","authDomain":"miapp-recetas-2132904.firebaseapp.com","messagingSenderId":"1047713110321","measurementId":"G-Z07LZHHL9Z"})],
